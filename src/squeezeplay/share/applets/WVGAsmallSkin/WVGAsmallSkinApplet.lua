...
applets.WVGAsmallSkin.WVGAsmallSkinApplet
...
local log                    = require("jive.utils.log").logger("applet.WVGAsmallSkin")
...
local imgpath = "applets/WVGAsmallSkin/images/"
...
function param(self)
		...
		radialClock = {
			hourTickPath     = 'applets/WVGAsmallSkin/images/Clocks/Radial/radial_ticks_hr_on.png',
			minuteTickPath   = 'applets/WVGAsmallSkin/images/Clocks/Radial/radial_ticks_min_on.png',
		},
